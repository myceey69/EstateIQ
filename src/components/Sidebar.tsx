...
import { Home, FileText, Search, BarChart3, Shield, Star, FileOutput, LayoutDashboard, Layers, User, LogOut, ChevronRight } from 'lucide-react';
      ...
      <nav className="flex flex-col gap-1 mb-4 flex-1">
        {NAV_ITEMS.map(({ screen, icon: Icon, label }) => (
          ...
          >
            ...
            {screen === 'watchlist' && watchlist.length > 0 && (
              <span className="bg-destructive text-destructive-foreground text-[10px] font-bold min-w-[18px] h-[18px] rounded-full flex items-center justify-center px-1">
                {watchlist.length}
              </span>
            )}
          </button>
